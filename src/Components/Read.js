...
<tbody>
    <tr>
      ...
      <td>
        <Link to ="/update">
        <i class="fa-regular fa-pen-to-square fa-shake fa-2xl" onClick={()=>setToLocalStorage(
          eachData.id,
          eachData.name,
          eachData.email,
        ...
        delete</span></button> */}
        <i onClick={() => handleDelete(eachData.id)} class="fa-solid fa-trash fa-shake fa-2xl" style={{color: "#CD5C5C;"}}></i>
